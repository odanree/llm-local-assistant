...
import {
  ...
  assessImpactPure,
} from './utils/refactoringValidator';
...
test('description', async () => {
  ...
  private validateSyntax(code: string): ValidationResult {
    return validateSyntaxPure(code);
  }
  ...
  private validateLogic(originalCode: string, refactoredCode: string): ValidationResult {
    return validateLogicPure(originalCode, refactoredCode);
  }
  ...
  private validatePerformance(originalCode: string, refactoredCode: string): ValidationResult {
    return validatePerformancePure(originalCode, refactoredCode);
  }
  ...
  private validateCompatibility(originalCode: string, refactoredCode: string): ValidationResult {
    return validateCompatibilityPure(originalCode, refactoredCode);
  }
  ...
  private assessImpact(
    ...
    return assessImpactPure(plan, originalCode, refactoredCode);
  }
